...
import RemoveAccountModal from '../../../../compoent/RemoveAccountModal';

const ProfileSettingOwner = () => {
   const {
     navigation ,
    handleLogout,
   ...
   const [modalVisible1, setModalVisible2] = useState(false);
     ...
     const handleRemove = () => {
       ...
       // यहां तुम अपना API call या account remove logic लगा सकते हो
       console.log("Account Removed!");
       navigation.navigate(ScreenNameEnum.AccountRemoveSuccess)
     };
...
style={[styles.email,{
    ...
    marginTop:2
      ...
      <View style={styles.menuContainer}>
        ...
        />
        <MenuItem icon="person-circle-outline" label="Location"  
          icon={imageIndex.profile2}
        ...
        <MenuItem icon="log-out-outline" label="Remove Owner Account"
...
export default ProfileSettingOwner;
