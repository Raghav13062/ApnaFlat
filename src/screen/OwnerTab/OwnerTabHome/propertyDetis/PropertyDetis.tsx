 ...
 style={styles.thumbnail} />
      ...
      <View style={styles.details}>
        <View style={styles.rowSpace}>
          ...
          <Text style={styles.price}>₹4500/<Text style={styles.subText}>Month</Text></Text>
        </View>
<View style={{
  flexDirection:"row",
  alignItems:"center",
  ...
  marginBottom:11,
        ...
        <View style={styles.row}>
        <Text style={[styles.tag,{ fontSize:14, color:"black"}]}>2024 ⇅</Text>
        </View>
        </View>
        <View style={{
  ...
  {[1,2].map((item, index) => (
    <View key={index} style={styles.featureRow}>
      <View style={styles.featureBox}>
        ...
        />
        <Text style={styles.featureText}>2 Bedroom</Text>
      </View>
    </View>
  ))}
</ScrollView>
